...
$APPLICATION->SetPageProperty("description", "«ТАФИ-Диагностика» - Мы используем оборудование и реагенты от ведущих мировых брендов. Высокая точность и качество прежде всего!");
$APPLICATION->SetPageProperty("keywords", "бренды, оборудование, тафи, анализы, диагностика");
$APPLICATION->SetPageProperty("title", "Оборудование «ТАФИ-Диагностика»");
$APPLICATION->SetTitle("«ТАФИ-Диагностика» Оборудование и бренды");
