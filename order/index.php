...
<?$APPLICATION->IncludeComponent(
	...
	[
		...
		"EMPTY_BASKET_HINT_PATH" => "/basket/",
		"USE_PHONE_NORMALIZATION" => "Y",
		"HIDE_ORDER_DESCRIPTION" => "N",
		"MESS_AUTH_BLOCK_NAME" => "Авторизация",
		"MESS_REG_BLOCK_NAME" => "Регистрация",
		"MESS_BASKET_BLOCK_NAME" => "Исследования в корзине",
		"MESS_REGION_BLOCK_NAME" => "Клиент",
		"MESS_PAYMENT_BLOCK_NAME" => "Способ оплаты",
		"MESS_DELIVERY_BLOCK_NAME" => "Способ доставки",
		"MESS_BUYER_BLOCK_NAME" => "Данные пациента, которому необходимо сдать анализы",
		"MESS_BACK" => "Назад",
		"MESS_FURTHER" => "Далее",
		"MESS_EDIT" => "изменить",
		...
		"MESS_PICKUP_LIST" => "Адреса клиник:",
		...
		"MESS_SUCCESS_PRELOAD_TEXT" => "Вы заказывали на нашем сайте, поэтому мы заполнили все данные автоматически. Если все заполнено верно, нажмите кнопку \"#ORDER_BUTTON#\".",
		"MESS_FAIL_PRELOAD_TEXT" => "Вы заказывали на нашем сайте, поэтому мы заполнили все данные автоматически. Обратите внимание на развернутый блок с информацией о заказе. Здесь вы можете внести необходимые изменения или оставить как есть и нажать кнопку \"#ORDER_BUTTON#\".",
		"MESS_DELIVERY_CALC_ERROR_TITLE" => "Не удалось рассчитать стоимость доставки.",
		"MESS_DELIVERY_CALC_ERROR_TEXT" => "Вы можете продолжить оформление заказа, а чуть позже менеджер сайта свяжется с вами и уточнит информацию по доставке.",
