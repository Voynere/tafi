...
$APPLICATION->SetPageProperty("description", "Раздел новостей лаборатории «ТАФИ-Диагностика». Здесь вы можете ознакомиться с новостями и жизнью нашей лаборатории.");
$APPLICATION->SetPageProperty("keywords", "ТАФИ-Диагностика, новости, блог, записи");
$APPLICATION->SetPageProperty("title", "«ТАФИ-Диагностика» Новости");
$APPLICATION->SetTitle("Новости «ТАФИ-Диагностика»");
?>
<?$APPLICATION->IncludeComponent(
	...
	[
		...
		"T_SERVICES" => "",
		"T_STUDY" => "",
		"COMPONENT_TEMPLATE" => "news-redesign",
		"SET_LAST_MODIFIED" => "N",
		"T_VIDEO" => "",
