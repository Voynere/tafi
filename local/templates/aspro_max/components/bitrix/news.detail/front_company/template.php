								...
								<div class="text">
									...
									<? else : ?>
										<? if (isset($arResult['DISPLAY_PROPERTIES']['COMPANY_NAME']) && $arResult['DISPLAY_PROPERTIES']['COMPANY_NAME']['VALUE']) : ?>
											...
											<h1 class="h3"><?= $arResult['DISPLAY_PROPERTIES']['COMPANY_NAME']['VALUE']; ?></h3>
											<? endif; ?>
										...
										<div class="buttons">
											...
											<? endif; ?>
											<!-- <div class="btn-wrap">
												<span class="btn btn-default btn-wide animate-load colored_theme_hover_bg-el" data-event="jqm" data-param-form_id="FEEDBACK" data-name="feedback">
													<?= GetMessage('LETTER_TO_DIRECTOR') ?>
												</span>
											</div> -->
										</div>
