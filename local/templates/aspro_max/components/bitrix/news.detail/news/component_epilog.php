...
$prices = [
    [
        "name" => "Прием (осмотр, консультация) врача-специалиста на дому в черте города",
        "price" => "6500 руб."
    ],
    [
        "name" => "Прием (осмотр, консультация) врача-специалиста на дому в пригороде и на о. Русском",
        "price" => "7000 руб."
    ],
    [
        "name" => "Прием (осмотр, консультация) врача-специалиста на дому в г. Артем и в районе б. Лазурная",
        "price" => "7500 руб."
    ],
    [
        "name" => "Выполнение стрептатеста (экспресс-диагностика мазка из зева на стрептококк группы A) на дому",
        "price" => "1000 руб."
    ],
    [
        "name" => "Взятие мазков со слизистой носа и глотки на дому",
        "price" => "500 руб."
    ],
    [
        "name" => "Выполнение экспресс-теста на Covid-19 и грипп А и В в мазке из носа на дому",
        "price" => "1100 руб."
    ],
    [
        "name" => "Электрокардиография (ЭКГ) на дому",
        "price" => "1500 руб."
    ],
    [
        "name" => "СМАД (суточное мониторирование артериального давления) на дому (постановка и снятие)",
        "price" => "4500 руб."
    ],
    [
        "name" => "Холтер ЭКГ (суточное мониторирование сердечного ритма) на дому (постановка и снятие)",
        "price" => "5500 руб."
    ],
    [
        "name" => "Постановка мочевого катетера и мочеприемника",
        "price" => "3300 руб."
    ]
];
?>
...
<div class="new-template__price home new-template__container">
    <h2 class="adaptive-h2">Стоимость</h2>
