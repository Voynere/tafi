...
<?if(!empty($arResult["ITEMS"])) {?>
    <div class="product-carousel js-product-carousel-container">
        ...
        <div class="product-carousel__header">
            ...
            <?}?>
            <?if($arParams['SECTION_LINK_ALL']){?>
                <a class="product-carousel__link-all" href="<?=$arParams['SECTION_LINK_ALL']?>">
                    <?=GetMessage('CT_BCS_BTN_LOOK_ALL')?>
        ...
        <div class="product-carousel__nav">
            ...
            <div class="product-carousel__button product-carousel__button--prev js-product-carousel-prev">
                <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7 13L1 7L7 1" stroke="#5A616C" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </div>
            <div class="product-carousel__button product-carousel__button--next js-product-carousel-next">
                <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="product-carousel__wrap">
            ...
            <div class="swiper js-product-carousel">
                ...
                <div class="product-carousel__items swiper-wrapper" data-entity="<?=$containerName?>">
                    <?
                    if (!empty($arResult['ITEMS']) && !empty($arResult['ITEM_ROWS']))
                    {
                        ...
                        <div class="product-carousel__item swiper-slide">
                            <?
                            $APPLICATION->IncludeComponent("bitrix:catalog.item", 'main',
                                array(
                                    "RESULT" => array(
                                        "ITEM" => $item,
                ...
                <div class="product-carousel__pagination js-pagination"></div>
            </div>
