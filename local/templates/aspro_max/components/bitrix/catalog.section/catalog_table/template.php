	...
	<?endif?>
		...
		?>
			...
			<?foreach($arResult["ITEMS"]  as $arItem){
				...
				<div class="table-view__item item <?=($arItem['CATALOG_QUANTITY'] == 0 ? 'item_noavailable' : '')?> bordered box-shadow main_item_wrapper" id="<?=$this->GetEditAreaId($arItem['ID']);?>" data-id="<?=$arItem["ID"]?>" data-product_type="<?=$arItem["CATALOG_TYPE"]?>">
