	...
	<tr valign="top">
		<td width="40%">
			...
			<?if($arResult["ALLOW_REGISTER"]=="Y"):?>
				<p><?echo GetMessage("adm_reg1")?> <a href="<?=SITE_DIR?>auth/registration/?backurl=<?=SITE_DIR;?>personal/subscribe/<?/*echo $arResult["FORM_ACTION"]?>?register=YES&amp;sf_EMAIL=<?echo $arResult["REQUEST"]["EMAIL"]?><?echo $arResult["REQUEST"]["RUBRICS_PARAM"]*/?>"><?echo GetMessage("adm_reg2")?></a>.</p>
			<?endif;?>
		</td>
	</tr>
	</table>
