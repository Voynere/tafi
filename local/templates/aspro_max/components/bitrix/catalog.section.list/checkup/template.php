      ...
      <div class="<? echo $arCurView['LIST']; ?>"  >
        ...
        case 'TILE':
          foreach ($arResult['SECTIONS'] as &$arSection)
          {
            ...
            ?>
              <div id="<? echo $this->GetEditAreaId($arSection['ID']); ?>" class="tile-card">
                  ...
                  <a href="<? echo $arSection['SECTION_PAGE_URL']; ?>"
                    <?if($arSection['DETAIL_PICTURE'] == ''){?>
                        style="background-image: url('<? echo $arSection['PICTURE']['SRC']; ?>');background-repeat: no-repeat;background-size: contain;height: 207px;background-position: center"
                    <?}?>
                     title="<? echo $arSection['PICTURE']['TITLE']; ?>">
