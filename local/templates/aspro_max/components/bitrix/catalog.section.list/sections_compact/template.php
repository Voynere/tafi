...
<?if($arResult["SECTIONS"]){?>
	...
	<div class="section-compact-list">
        ...
        $sectionLink = $arItems['UF_SECTION_LANDING_PAGE'] ?: $arItems["SECTION_PAGE_URL"];
			?>
				<div class="col-lg-3 col-md-4 col-xs-6 col-xxs-12">
					<div class="section-compact-list__item item bordered box-shadow flexbox flexbox--row" id="<?=$this->GetEditAreaId($arItems['ID']);?>">
						...
						<div class="section-compact-list__info">
							<a href="<?=$sectionLink?>" class="section-compact-list__link dark_link option-font-bold"><span><?=$arItems["NAME"]?></span></a>
