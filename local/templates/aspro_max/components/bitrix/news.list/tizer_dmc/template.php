    ...
    <div class="maxwidth-theme">
			<div class="dmc-tizer__row">
                <?foreach($arResult['ITEMS'] as $i => $arItem):?>
                    ...
                    <div class="dmc-tizer__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                        <div class="dmc-tizer__item_image">
                            <img src=" <?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt="">
                        </div>
                        <div class="dmc-tizer__item_name">
                            <p><?=$arItem['NAME']?></p>
                        </div>
                    </div>
                <div class="dmc-tizer__arrow">
                    <img src="<?=SITE_TEMPLATE_PATH?>/images/Arrow-dmc.png" alt="">
                </div>
                <?endforeach;?>
			</div></div></div></div>
			<?if($arParams['INCLUDE_FILE']):?>
