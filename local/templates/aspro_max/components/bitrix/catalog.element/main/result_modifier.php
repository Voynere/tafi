...
$priceCode = str_replace('PROPERTY_','', $arParams["UF_PRICE_CODE"]);
if($priceCode){
	$priceNew = $arResult['PROPERTIES'][$priceCode]['VALUE'];
	$productId = $arResult['ID'];
	$arResult["PRICES"] = \Itb\MultiDomains\Site::getPrice($productId, $arResult["PRICES"], $priceNew);
	if( $priceNew ){
		$arResult['MIN_PRICE'] = $arResult["PRICES"]['BASE'];
	}
...
$arResult['HIDE_CITY'] = $arResult['PROPERTIES']['HIDE_CITY']["VALUE"]; 
