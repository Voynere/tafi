...
$MESS["SOA_ORDER_SUC"] = "Спасибо за ваш заказ <b>№#ORDER_ID#</b> от #ORDER_DATE#.Предварительный расчет сформирован и отправлен вам на электронную почту. Оператор перезвонит вам для подтверждения заказа и уточнения деталей.";
$MESS["SOA_ORDER_SUC2"] = "Ждем вас в филиале, который вы выбрали для сдачи анализов. Пожалуйста, при обращении назовите регистратору номер заказа и ваше ФИО. Ваш заказ активен 14 дней.";
...
$MESS["SOA_SUM_SUMMARY"] = "Исследований на:";
...
$MESS["PICKUP_LIST_DEFAULT"] = "Адреса клиник:";
...
$MESS["SOA_SUM_SUMMARY_WITH_SERVICES"] = "Исследований и услуг на:";
?>
