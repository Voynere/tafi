						...
						<div class="info">
							<div class="row">
								<? if (\Bitrix\Main\Loader::includeModule('subscribe') && $arTheme['HIDE_SUBSCRIBE']['VALUE'] != 'Y') : ?>
									<div class="col-md-12 col-sm-12 subscribe-button-wrap">
								...
								<? endif; ?>
								<div class="col-md-12 col-sm-12 btn-feedback-wrap">
									<span class="btn btn-default btn-wide animate-load colored_theme_hover_bg-el" data-event="jqm" data-param-form_id="SIMPLE_FORM_13" data-name="SIMPLE_FORM_13">Письмо директору</span>
								</div>
						...
						<div class="pull-right">
							<div class="pays">
								<? $APPLICATION->IncludeFile(
									SITE_DIR . "include/footer/copy/pay_system_icons.php",
									array(),
									array(
										"MODE" => "php",
										"NAME" => "onfidentiality",
