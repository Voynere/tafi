...
if(\Bitrix\Main\Loader::includeModule('itb.multidomains')){
	...
	if($city["SITE_DIR"]){
		$SITE_DIR = $city["SITE_DIR"];
		$arFrontParametrs['CATALOG_PAGE_URL'] =  $city["SITE_DIR"].ltrim($arFrontParametrs['CATALOG_PAGE_URL'], '/');
		$arFrontParametrs['BASKET_PAGE_URL'] = $city["SITE_DIR"].ltrim($arFrontParametrs['BASKET_PAGE_URL'], '/');
	}
}
