...
?>
<form class="subscribe-form" action="<?=$arResult["FORM_ACTION"]?>" method="post">
...
<tfoot><tr><td colspan="2">
	...
	<?if($arTheme["SHOW_LICENCE"]["VALUE"] == "Y" && !$arResult["ID"] ):?>
		<div class="subscribe_licenses">
			<div class="licence_block filter label_block">
				...
				<input required type="checkbox" id="licenses_subscribe" <?=($_POST["licenses_subscribe"] ? "checked" : ($_POST ? "" : ($arTheme["SHOW_LICENCE"]["DEPENDENT_PARAMS"]["LICENCE_CHECKED"]["VALUE"] == "Y" ? "checked" : "")));?> name="licenses_subscribe" value="Y">
	...
	<?endif;?>
        <div class="captcha">
            ...
            <input required id="captcha_word"name="captcha_word"type="text">
        </div>
