...
if(!$APPLICATION->CaptchaCheckCode($_POST["captcha_word"], $_POST["captcha_code"]) && $_POST["captcha_word"])
{
	array_push($arWarning, GetMessage('CAPTCHA_ERROR'));
}

if ($_POST["licenses_subscribe"] != "Y" && isset($_POST["licenses_subscribe"]) && empty($_POST["licenses_subscribe"]))
{
	array_push($arWarning, GetMessage('LICENSES_ERROR'));
}
