...
class Version20251028092434 extends Version
{
    protected $author = "admin";

    protected $description = "новые свойства инфоблока Направления";
  ...
  'NAME' => 'Блок карточек 3 активен',
  'ACTIVE' => 'Y',
  'SORT' => '1600',
  'CODE' => 'PROP_CARDS3_ACTIVE',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'L',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  array (
    ...
    array (
      ...
      'XML_ID' => 'Y',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Положение блока карточек 3',
  'ACTIVE' => 'Y',
  'SORT' => '1610',
  'CODE' => 'PROP_CARDS3_POSITION',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Заголовок блока карточек 3',
  'ACTIVE' => 'Y',
  'SORT' => '1620',
  'CODE' => 'PROP_CARDS3_TITLE',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'S',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Картинка для карточки 1',
  'ACTIVE' => 'Y',
  'SORT' => '1635',
  'CODE' => 'PROP_CARDS3_IMAGE1',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'F',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Картинка для карточки 2',
  'ACTIVE' => 'Y',
  'SORT' => '1645',
  'CODE' => 'PROP_CARDS3_IMAGE2',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'F',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Картинка для карточки 3',
  'ACTIVE' => 'Y',
  'SORT' => '1655',
  'CODE' => 'PROP_CARDS3_IMAGE3',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'F',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'HINT' => '',
            ...
            $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Картинка для карточки 4',
  'ACTIVE' => 'Y',
  'SORT' => '1665',
  'CODE' => 'PROP_CARDS3_IMAGE4',
  'DEFAULT_VALUE' => '',
  'PROPERTY_TYPE' => 'F',
  'ROW_COUNT' => '1',
  'COL_COUNT' => '30',
  ...
  'Карточки текст+картинка|cedit14' => 
  array (
    'PROPERTY_PROP_CARDS3_ACTIVE' => 'Блок карточек 3 активен',
    'PROPERTY_PROP_CARDS3_POSITION' => 'Положение блока карточек 3',
    'PROPERTY_PROP_CARDS3_TITLE' => 'Заголовок блока карточек 3',
    'PROPERTY_PROP_CARDS3_1' => 'Карточка 1 (3)',
    'PROPERTY_PROP_CARDS3_IMAGE1' => 'Картинка для карточки 1',
    'PROPERTY_PROP_CARDS3_2' => 'Карточка 2 (3)',
    'PROPERTY_PROP_CARDS3_IMAGE2' => 'Картинка для карточки 2',
    'PROPERTY_PROP_CARDS3_3' => 'Карточка 3 (3)',
    'PROPERTY_PROP_CARDS3_IMAGE3' => 'Картинка для карточки 3',
    'PROPERTY_PROP_CARDS3_4' => 'Карточка 4 (3)',
    'PROPERTY_PROP_CARDS3_IMAGE4' => 'Картинка для карточки 4',
  ),
